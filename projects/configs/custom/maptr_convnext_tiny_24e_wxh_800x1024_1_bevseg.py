...
model = dict(
    ...
    # pretrained=dict(img='ckpts/convnext-base_in21k-pre-3rdparty_32xb128_in1k_20220124-eb2d6ada.pth'),
    pretrained = dict(img="ckpts/convnext-tiny.pth"),
    img_backbone=dict(
        type='ConvNeXt',
        arch="tiny",
        in_channels=3,
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            use_can_bus=True,
            embed_dims=_dim_,
            bev_seg_head=bev_seg_head,      #  bev-seg-heads
            encoder=dict(
...
# data_root = "/GPU-test2/openlanev2/"
val_root = "/GPU-test2/val"
...
train_pipeline = [
    ...
    dict(type='ResizeMultiViewImageForArgo',resize=(1550, 2048)),
...
log_config = dict(
    ...
    hooks=[
        ...
        #         name='SegAuxLoss_deeplabv3_dice15_ce0.5_bs2_lr3e-4_x8')
        # ),
    ])
...
# load_from='/home/jiangshengyin/shengyin/CVPR_hdmap/work_dirs/maptr_tiny_r50_24e_800x1024_bevseg/latest.pth'
