...
def main():
    ...
    # dataset = build_dataset(cfg.data.test)  # TODO, TEST NEED TO MODIFY
    ...
    car_img = Image.open("/cpfs01/user/jiangmingchao/work/code/Online-HD-Map-Construction-CVPR2023-master/resources/images/car.png")
    ...
    for i, data in enumerate(data_loader):
        ...
        sample_dir = osp.join(args.show_dir, scene_token)
        ...
        for filepath in filename_list:
            ...
            img_path_dict[img_name.split('.')[0]] = img_path
         
        # surrounding view, 画环视图
